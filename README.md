...
Website to convert english text or pdf to AutoCAD file containing grade-2 braille, for use in TAMU laser cutter to produce physical braille on capsule paper.
